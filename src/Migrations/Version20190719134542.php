 ...
 */
final class Version20190719134542 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD nom VARCHAR(255) NOT NULL, ADD prenom VARCHAR(255) NOT NULL, ADD phone VARCHAR(255) NOT NULL, CHANGE roles roles JSON NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP nom, DROP prenom, DROP phone, CHANGE roles roles LONGTEXT NOT NULL COLLATE utf8mb4_bin');
    }
}
