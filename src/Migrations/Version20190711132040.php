 ...
 */
final class Version20190711132040 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activite CHANGE entreprise_id entreprise_id INT DEFAULT NULL, CHANGE poste_id poste_id INT DEFAULT NULL, CHANGE ecole_id ecole_id INT DEFAULT NULL, CHANGE titre_id titre_id INT DEFAULT NULL, CHANGE place place TINYINT(1) DEFAULT NULL, CHANGE date_debut date_debut DATETIME NOT NULL, CHANGE date_de_fin date_de_fin DATETIME DEFAULT NULL');
